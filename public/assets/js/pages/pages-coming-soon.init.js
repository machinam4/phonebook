    ...
    mainArray.forEach(function (item) {
        ...
        var countDown = setInterval(function () {
            ...
            if (distance < 0) {
                ...
                <div class="mt-5 mb-4">
                    <h4 class="mb-2">Homepage is Coming</h4>
                    <p class="text-slate-500 dark:text-zink-200">Click the below to login to DialDeck Dashboard.</p>
                </div>
                <a href="/home" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Login to Dashboard</a>
            </div>`;
            }
        }, 1000);
    });
